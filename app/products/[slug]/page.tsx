        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-28 flex flex-col gap-6">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2">
                {product.materials.map((m) => (
                  <li
                    key={m}
                    className="flex items-center gap-2.5 font-body text-[13px] text-text-secondary"
                  >
              ...
              <div className="grid grid-cols-3 divide-x divide-accent/20 border border-accent/20">
                {(
                  ...
                  <div key={label} className="flex flex-col items-center py-4 gap-1">
                    <span className="font-heading text-[20px] font-light text-text-primary">
                      {value}
                    </span>
                    <span className="font-body text-[9px] uppercase tracking-[0.2em] text-text-secondary/60">
                      {label}
                    </span>
                  </div>
                ))}
            ...
            <div className="flex flex-col gap-3 pt-2">
              <a
                href={`mailto:hello@lusano.com?subject=Inquiry: ${product.name}`}
